			                         	...
			                         	<table class="modifytb">
											...
											<tr>
												...
												<td>
													...
													<span class="warning" id="ntext">Please enter the Name.</span>
												</td>	 
											</tr>                           	
											<tr>
												<th>Phone</th>
												<td>
													...
													<span class="warning" id="phtext">Please enter the Phone.</span>
												</td>		 
											</tr>                           	
											<tr>
												<th>Email</th>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		let memberCk = function() {
			...
			if($("[name=phone1]").val()==null || !($("[name=phone1]").val()) || !($.isNumeric($("[name=phone1]").val()))) {
				open();
				$("#phtext").show();
				$("[name=phone1]").focus();
				return false;
			} else if($("[name=phone2]").val()==null || !($("[name=phone2]").val()) || !($.isNumeric($("[name=phone2]").val()))) {
				open();
				$("#phtext").show();
				$("[name=phone2]").focus();
				return false;
			} else if($("[name=phone3]").val()==null || !($("[name=phone3]").val()) || !($.isNumeric($("[name=phone3]").val()))) {
				open();
				$("#phtext").show();
				$("[name=phone3]").focus();
				return false;
